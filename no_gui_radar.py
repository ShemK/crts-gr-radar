...
class usrp_echotimer_dual_cw(gr.top_block):
    ...
    def __init__(self):
        ...
        parser.add_option('-a', action="store", dest="crts_controller_ip", default=False, help="crts_controller_ip")
        parser.add_option('-c', action="store", dest="config_file", default=False, help="config_file")
        parser.add_option('-n', action="store", dest="node_num", default=False, help="node_num")
        ...
        if(options.crts_controller_ip):
            self.crts_controller_ip =  str(options.crts_controller_ip)
            self.controller = crts_connector(self.crts_controller_ip)
